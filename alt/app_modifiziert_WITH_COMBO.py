...
<div style="margin-top: 1em;">
  <label for="model-select"><strong>Modell wählen:</strong></label>
  <select id="model-select">
    <option value="granite">Granite 3.3 (2B)</option>
...
<table>
  ...
  <tbody>
    <tr><td>mistral</td><td>Schnell, gute Deutschleistung</td></tr>
    <tr><td>llama3</td><td>Groß, präzise, langsam</td></tr>
    <tr><td>tinyllama</td><td>Sehr klein, englisch fokussiert</td></tr>
    <tr><td>gemma</td><td>Mittelgroß, balanciert, stabil</td></tr>
  </tbody>
</table>
<br><br>
...
<div id="model-status" style="margin-top: 10px;">
  Aktuell geladenes Modell: <strong id="model-name">–</strong>
